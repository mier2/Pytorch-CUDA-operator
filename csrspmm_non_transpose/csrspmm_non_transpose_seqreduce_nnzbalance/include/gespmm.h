...
void csrspmm_non_transpose_seqreduce_nnzbalance_cuda(const SpMatCsrDescr_t spmatA,
                                                ...
                                                float *C);
// -- parreduce --
void csrspmm_parreduce_rowbalance_cuda(const SpMatCsrDescr_t spmatA, const float *B,
                                  const int N, float *C);
void csrspmm_parreduce_nnzbalance_cuda(const SpMatCsrDescr_t spmatA, const float *B,
                                  const int N, float *C);
// -- seqreduce --
void csrspmm_seqreduce_rowbalance_cuda(const SpMatCsrDescr_t spmatA, const float *B,
                                  const int N, float *C);
void csrspmm_seqreduce_nnzbalance_cuda(const SpMatCsrDescr_t spmatA, const float *B,
                                  const int N, float *C);
// -- row-caching --
void csrspmm_rowcaching_rowbalance_cuda(const SpMatCsrDescr_t spmatA, const float *B,
                                   const int N, float *C);
void csrspmm_rowcaching_nnzbalance_cuda(const SpMatCsrDescr_t spmatA, const float *B,
                                   const int N, float *C);
}
#endif // GESPMM_H
