...
import numpy
import unittest
import csrspmm_rowcaching_rowbalance_ext as csrspmm
...
class TestSparseMM(unittest.TestCase):
    def test_sparse_mm(self):
        ...
        csrspmm.csrspmm_rowcaching_rowbalance(3, 3, 5, A_csr_row_ptrs, A_csr_col_indices, A_csr_values, B_dense, 1, C)
